...
exports.unique = exports.repeat = exports.randomArray = undefined;
 ...
 */
var unique = exports.unique = function unique(provider, min, max) {
  var count = max ? (0, _util.randomRange)(min, max) : min;
